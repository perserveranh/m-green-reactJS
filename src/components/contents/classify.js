     ...
     <div className="vc_empty_space  hidden-xs" style={{height: '60px'}}><span className="vc_empty_space_inner"></span></div>
      ...
      <Col xs="12" md="6" lg="4">
        <div className="wpb-wrapper text-center">
          ...
          <p className="p-text">Phân loại và thu gom rác tái chế</p>
        </div>
      </Col>
      <Col xs="12" md="6" lg="4">
      <div className="wpb-wrapper text-center">
          ...
          <p className="p-text">Thẻ mGreen được dùng để tích điểm</p>
        </div></Col>
      <Col xs="12" md="6" lg="4">
      <div className="wpb-wrapper text-center">
          ...
          <p className="p-text">Người dùng được tích điểm, tặng quà</p>
        </div></Col>
      </Row>
      <div className="vc_empty_space  hidden-xs" style={{height: '60px'}}><span className="vc_empty_space_inner"></span></div>
      </Container>
