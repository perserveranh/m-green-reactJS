        ...
        <Container>
          <Row>
            ...
            <Col xs="12" md="4" className="py-3 footer-right" >
              <div>
                <img className="footer-img-logo" src="/image/logo.png" alt="img-mgreen" />
              </div>
              <div className="row py-3">
                <a href="https://www.facebook.com/mgreen.thetichdiemphanloairac/?ref=br_rs" className="col-3"><img src="/image/facebookF@3x.png" className=" footer-icon-img" alt="img-mgreen" /></a>
                <a href="https://www.facebook.com/mgreen.thetichdiemphanloairac/?ref=br_rs" className="col-3"><img src="/image/twitterF@3x.png" className="footer-icon-img " alt="img-mgreen" /></a>
                <a href="https://www.facebook.com/mgreen.thetichdiemphanloairac/?ref=br_rs" className="col-3"><img src="/image/googleplusF@3x.png" className=" footer-icon-img" alt="img-mgreen" /></a>
              </div>
            </Col>
          </Row>
        </Container>
